...
`fetch.packfileUriJobs`::
	Specifies the maximum number of packfile URI downloads to run in
	parallel at a time when the server advertises packfile URIs.
+
A value of 0 will give some reasonable default. If unset, it defaults to 8.
